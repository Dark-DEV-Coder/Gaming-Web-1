...
<?php
    ...
    $p=new CheckConnection(); 
        if (isset($_GET['idctkh'])){            
            $id=$_GET['idctkh'];
            $sql2="select * from nhanvien where MaNV='$id'";                                
            ...
            <div class='row ctkh-emailkh'>
                ...
                <div class='col-md-7 col-sm-7'><input id='ctkh-emailkh-edit' type='text' value='$row2[8]' /></div>
        ...
        if (isset($_GET['idKH'])){
            ...
            if ($gtkh=="Nữ")
                $gt=1;                                      
            $sqlkh="UPDATE `nhanvien` SET `Ho`='$hokh',`Ten`='$tenkh',`DiaChi`='$dckh',`DienThoai`='$dtkh',`NgaySinh`='$ngaysinhkh',`GioiTinh`=$gt,`Email`='$emailkh' WHERE MaNV='$makh'";                
            echo ($sqlkh);
            $p->Check($sqlkh);                                                                     
        }
        if (isset($_GET['idKHx'])){
            ...
            if ($gtkh=="Nữ")
                $gt=1;
            $sqltk="UPDATE taikhoan,nhanvien SET taikhoan.TinhTrang=2 WHERE taikhoan.MaTK=nhanvien.MaTK AND nhanvien.MaNV='$makh'";                                      
            $sqlkh="UPDATE `nhanvien` SET `TinhTrang`=1 WHERE MaNV='$makh'";            
            $p->Check($sqlkh);
            $p->Check($sqltk);                                                                     
        }          
?>
<script>
    ...
    $(document).ready(function(){
        $("#ctkh-bt-sua").click(function(){
            ...
            $("#loiemailkh").html("");
            $.get("./xemchitietnv.php",{idKH:makh, hoKH:hokh,tenKH:tenkh,dtKH:dtkh,ngaysinhKH:ngaysinhkh,gtKH:gtkh,dcKH:dckh,emailKH:emailkh}, function(data){                                               
        ...
        $("#ctkh-bt-xoa").click(function(){
            if (confirm('Bạn có chắc muốn xóa')){
                ...
                $("#loiemailkh").html("");
                $.get("./xemchitietnv.php",{idKHx:makh, hoKH:hokh,tenKH:tenkh,dtKH:dtkh,ngaysinhKH:ngaysinhkh,gtKH:gtkh,dcKH:dckh,emailKH:emailkh}, function(data){                                               
